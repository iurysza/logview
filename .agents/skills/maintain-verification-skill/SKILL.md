...
description: Audits and maintains a project's verification skill and feature map using parallel source readers and one live pass across every feature. Use only when the user explicitly asks to maintain, audit, or repair an existing verification skill.
metadata:
